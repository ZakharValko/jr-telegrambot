...
@Component
public class JavaRushGroupClientImplementation implements JavaRushGroupClient{

    private final String javarushApiGroupPath;

    public JavaRushGroupClientImplementation(@Value("${javarush.api.path}") String javarushApi) {
